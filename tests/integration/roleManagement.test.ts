...
// SKIPPED: this suite deploys streams to verify role-gated writes, which
...
//   - node/tests/streams/auth (role grant/revoke + write authorization)
...
describe.skip.sequential("Role Management", { timeout: 360000 }, () => {
